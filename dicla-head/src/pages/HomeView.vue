<template>
  <div class="">
    <div class="h-[calc(100vh-70px)] relative bg-blue-50 overflow-hidden z-20">
      <div
        ref="layer1"
      ...
      >
        <div class="relative w-full flex justify-center pt-20">
          <div ref="condorRef" class="absolute w-[320px] -top-[45px] right-0">
            <img
              class="w-full"
              src="http://dicla-travel-wph.local/wp-content/uploads/2025/12/condor_animal.png"
              alt=""
            />
          </div>
    ...
    <div class="bg-neutral-100 h-fit flex flex-col justify-center items-center relative z-20 py-12">
...
// const firstCondorAnimation = ref(false``)
...
.layer2 {
  height: 100vh;
  background-image: url('http://dicla-travel-wph.local/wp-content/uploads/2025/12/Sacsayhuaman_Cusco_Peru_2015-07-31_DD_01.png');
...
.layer3 {
  height: 100vh;
  background-image: url('http://dicla-travel-wph.local/wp-content/uploads/2025/12/montanas-hero.avif');
...
.layer4 {
  height: 100vh;
  background-image: url('http://dicla-travel-wph.local/wp-content/uploads/2025/12/machu-picchu-hero.avif');
